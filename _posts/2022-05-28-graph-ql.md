...
<div style="text-align: center">
  <img src="/content/hackathon.png" alt="" width="80%" />
</div> <p> </p>
...
team building, creativity and sometimes even bring ideas that end up changing the company's product. I am
 a true believer of this process and today I will explain two examples of projects, to the extent I am allowed
 due to confidentiality, NDAs, etc.
 </p>
...
e.g. [Prodigy](https://prodi.gy/) from SpaCy.
...
<p style="text-align: justify;">
As I explained above, we received a lot of attention, and we are on discussions to implement in some way 
...
link the interested reader to this [Github repository](https://github.com/marctorsoc/graphql_intro/),
